        ...
        <div class="modal-content">
            <form action="{{route('update-user',[$user->id])}}" method="post">
                ...
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">{{ __('Update Member Details') }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="mobile" type="text"
                               ...
                               value="{{ $user->mobile }}" autocomplete="mobile" autofocus>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <select id="gender" type="text"
                                ...
                                autocomplete="gender" autofocus required>
                            @foreach(\App\Enums\GenderEnum::getGender() as $gender)
                                <option value="{{$gender}}"
                                        @if($gender==$user->gender) selected @endif>{{$gender}}</option>
                            @endforeach
                        </select>
                        @error('gender')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <select id="user_type" type="text"
                            ...
                            @foreach(\App\Enums\UserTypeEnum::getUserTypes() as $type)
                                <option
                                    value="{{$type}}"
                                    @if($user->user_type==$type) selected @endif > @if($type==\App\Enums\UserTypeEnum::MEMBER){{"Member"}}@elseif($type==\App\Enums\UserTypeEnum::TRAINER){{"Trainer"}}@else{{"Administrator"}}@endif</option>
                            @endforeach
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Update Member
                        Details
                    </button>
                </div>
            </form>
