...
//...
    ...
    */
    ...
    {
        return User::query()->join('clubs', 'users.club_id', 'clubs.id')
            ->select('users.*', 'clubs.name as club');
    }
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('dob')
            ->addColumn('user_type')
            ->addColumn('joining_date_formatted', function (User $model) {
                return Carbon::parse($model->joining_date)->format('Y-m-d H:i:s');
            })
            ->addColumn('terms_and_conditions')
            ->addColumn('club')
            ...
            ->addColumn('updated_at_formatted', function (User $model) {
                return Carbon::parse($model->updated_at)->format('Y-m-d H:i:s');
            });
    }
...
//                ->makeInputText(),
            ...
            Column::add()
                ->title('JOINING DATE')
                ->field('joining_date_formatted', 'joining_date')
//                ->searchable()
                ->sortable(),
//                ->makeInputDatePicker('joining_date'),
